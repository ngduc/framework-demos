...
KitchenSink.ControlsListViewPage7Template = M.ListItemView.design({
...
KitchenSink.ControlsSelectionListViewPage6 = M.PageView.design({
    ...
    header: M.ToolbarView.design({
        ...
        title: M.LabelView.design({
            ...
            value: 'Selection list (multiple selection dialog)',
...
KitchenSink.ControlsLoaderViewPage2 = M.PageView.design({
    ...
    content: M.ScrollView.design({
        ...
        markup: M.LabelView.design({
            ...
            value: 'M.LoaderView.show(\'Custom message\');\n\nM.LoaderView.hide();',
...
KitchenSink.ControlsLoaderViewPage3 = M.PageView.design({
    ...
    content: M.ScrollView.design({
        ...
        markup: M.LabelView.design({
            ...
            value: 'M.LoaderView.show(\'Custom message\', YES);\n\nM.LoaderView.hide();',
...
KitchenSink.ControlsToggleSwitchViewPage1 = M.PageView.design({
    ...
    content: M.ScrollView.design({
        ...
        toggleswitch:M.ToggleSwitchView.design({
            label: 'I am the label and this switch has isMini:NO'
        }),
...
KitchenSink.app = M.Application.design({
    ...
    controlsListView7: KitchenSink.ControlsListViewPage7,
    ...
    controlsLoaderView3: KitchenSink.ControlsLoaderViewPage3,
    ...
    controlsSliderView: KitchenSink.ControlsSliderViewPage,

    controlsSliderView1: KitchenSink.ControlsSliderViewPage1,

    controlsSliderView2: KitchenSink.ControlsSliderViewPage2,

    controlsSliderView3: KitchenSink.ControlsSliderViewPage3,

    controlsSliderView4: KitchenSink.ControlsSliderViewPage4,
